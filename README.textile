...
To install, add the "snippets" folder to the addons/shared_addons/modules or addons/default/modules folder or your site.

h2. Usage

Create snippets and add the snippet code into your templates where you'd like them to be. Pretty simple! 
